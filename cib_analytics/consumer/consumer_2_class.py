from .engine import consumer_credit_card_engine
from .engine import general_engine

class ConsumerCreditCardClass:
    def __init__(self, cib_data):
        ...
        self.avg_get_overdue = consumer_credit_card_engine.avg_get_overdue(cib_data)
        self.get_overdue = general_engine.get_overdue(cib_data)
        self.cl_status  = general_engine.cl_status(cib_data)
        self.EMI = consumer_credit_card_engine.EMI_2(cib_data)
